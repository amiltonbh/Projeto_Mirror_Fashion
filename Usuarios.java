package backend;
	...
	public class Usuarios {
		...
		private Usuarios() {
			...
			System.out.println("##################################################");
			System.out.println("###########BEM VINDO A MIRROR FASHION#############");
			System.out.println("##################################################");
		...
		private String menu() {
			System.out.println("SELECIONA UMA OPÇÃO POR FAVOR:");
			System.out.println("N - CADASTRAR NOVO USUÁRIO");
			System.out.println("E - ENTRAR NO LOJA");
		...
		private void listarProdutos(){
			if (dados.size() == 0) {
				System.out.println("\nNão existem produtos para serem listados!!!\n");
			}
